...
namespace geonlp
{
  ...
  public:
    ...
    /// JSON からオブジェクトを復元する
    static Address fromJson(const std::string& json_str) throw (picojson::PicojsonException);
    ...
    inline double get_longitude() const throw (picojson::PicojsonException) { return this->_get_double("longitude"); }
    inline void set_latitude(double v) { this->_set_double("latitude", v); }
    inline double get_latitude() const throw (picojson::PicojsonException) { return this->_get_double("latitude"); }
    ...
    inline picojson::value get_code(void) const throw (picojson::PicojsonException) { return this->get_value("code"); }
