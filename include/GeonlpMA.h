...
namespace geonlp
{
  ...
  public:
    ...
    virtual std::string parse(const std::string & sentence) const
      throw (SqliteNotInitializedException, SqliteErrException, MeCabNotInitializedException, MeCabErrException) = 0;
    ...
    /// @exception SqliteErrException Sqlite3でエラー。
    /// @exception MeCabErrException MeCabでエラー。
    virtual int parseNode(const std::string & sentence, std::vector<Node>& ret) const
      throw (SqliteNotInitializedException, SqliteErrException, MeCabNotInitializedException, MeCabErrException) = 0;
    ...
    /// @exception SqliteNotInitializedException Sqlite3が未初期化。
    /// @exception SqliteErrException Sqlite3でエラー。
    virtual bool getGeowordEntry(const std::string & id, Geoword& ret) const
      throw (SqliteNotInitializedException, SqliteErrException) = 0;
    ...
    /// @exception SqliteNotInitializedException Sqlite3が未初期化。
    /// @exception SqliteErrException Sqlite3でエラー。
    virtual int getGeowordEntries(const std::string & surface, std::map<std::string, Geoword>& ret) const
      throw (SqliteNotInitializedException, SqliteErrException) = 0;
    ...
    /// @return 取得した地名語の数
    virtual int getGeowordEntries(const Node& node, std::map<std::string, Geoword>& ret) const
      throw (SqliteNotInitializedException, SqliteErrException) = 0;
    ...
    /// @exception SqliteNotInitializedException Sqlite3が未初期化。
    /// @exception SqliteErrException Sqlite3でエラー。
    virtual bool getWordlistBySurface(const std::string& key, Wordlist& ret) const
      throw (SqliteNotInitializedException, SqliteErrException) = 0;
    ...
    virtual bool findDictionaryById(int dictionary_id, Dictionary& ret) const = 0;
  ...
  MAPtr createMA(const std::string& profile = PACKAGE_NAME) throw(ServiceCreateFailedException);
